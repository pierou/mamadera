...
final class PipiColor {
  ...
  const PipiColor(
      {required this.value, required this.label, required this.colorHex});
  ...
  /// Label affiché à l'écran (ex: 'Jaune clair').
  final String label;
  ...
  static const incolore =
      PipiColor(value: 'incolore', label: 'Incolore', colorHex: 0xFFE8F5E9);
  static const jauneClair = PipiColor(
      value: 'jaune_clair', label: 'Jaune clair', colorHex: 0xFFFEEBC8);
  static const jauneFonce = PipiColor(
      value: 'jaune_fonce', label: 'Jaune foncé', colorHex: 0xFFE6C25B);
...
final class CacaColor {
  ...
  /// Label affiché à l'écran (ex: 'Jaune moutarde').
  final String label;
  ...
  static const meconium =
      CacaColor(value: 'meconium', label: 'Mécônium', colorHex: 0xFF5D4E37);
  static const vertOlive =
      CacaColor(value: 'vert_olive', label: 'Vert olive', colorHex: 0xFF8A9B6C);
  static const jauneMoutarde = CacaColor(
      value: 'jaune_moutarde', label: 'Jaune moutarde', colorHex: 0xFFF5D138);
  static const jauneClair = CacaColor(
      value: 'jaune_clair', label: 'Jaune clair', colorHex: 0xFFEED976);
...
final class HealthSubtype {
  /// Constructeur constant pour les instances immuables.
  const HealthSubtype({required this.value, required this.label});
  ...
  /// Label affiché à l'écran (ex: 'Nettoyage des yeux').
  final String label;

  // ── Instances statiques ───────────────────────

  static const nettoyageYeux =
      HealthSubtype(value: 'nettoyage_yeux', label: 'Nettoyage des yeux');
  static const nettoyageNombril =
      HealthSubtype(value: 'nettoyage_nombril', label: 'Nettoyage du nombril');
  static const nettoyageVisage =
      HealthSubtype(value: 'nettoyage_visage', label: 'Nettoyage du visage');
  static const nettoyageNez =
      HealthSubtype(value: 'nettoyage_nez', label: 'Nettoyage du nez');
  static const vitamineD =
      HealthSubtype(value: 'vitamine_d', label: 'Vitamine D');
  static const vitamineK =
      HealthSubtype(value: 'vitamine_k', label: 'Vitamine K');
...
enum HistoryFilter {
  ...
  /// Retourne le label affiché dans l'UI.
  String get label {
    switch (this) {
