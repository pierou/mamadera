...
// in mamadera/test/features/history/data/repositories/history_repository_impl_test.dart.
...
class _Fake$BabyProfilesTable_2 extends _i1.SmartFake
    implements _i3.$BabyProfilesTable {
  _Fake$BabyProfilesTable_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ReminderDismissalsTable_4 extends _i1.SmartFake
    implements _i3.$ReminderDismissalsTable {
  _Fake$ReminderDismissalsTable_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$ReminderSettingsTable_5 extends _i1.SmartFake
    implements _i3.$ReminderSettingsTable {
  _Fake$ReminderSettingsTable_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _Fake$CustomRemindersTable_6 extends _i1.SmartFake
    implements _i3.$CustomRemindersTable {
  _Fake$CustomRemindersTable_6(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeKey_24 extends _i1.SmartFake implements _i6.Key {
  _FakeKey_24(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockAppDatabase extends _i1.Mock implements _i3.AppDatabase {
  ...
  @override
  _i3.$BabyProfilesTable get babyProfiles => (super.noSuchMethod(
        Invocation.getter(#babyProfiles),
        returnValue: _Fake$BabyProfilesTable_2(
          this,
          Invocation.getter(#babyProfiles),
        ),
      ) as _i3.$BabyProfilesTable);
  ...
  @override
  _i3.$ReminderDismissalsTable get reminderDismissals => (super.noSuchMethod(
        Invocation.getter(#reminderDismissals),
        returnValue: _Fake$ReminderDismissalsTable_4(
          this,
          Invocation.getter(#reminderDismissals),
        ),
      ) as _i3.$ReminderDismissalsTable);

  @override
  _i3.$ReminderSettingsTable get reminderSettings => (super.noSuchMethod(
        Invocation.getter(#reminderSettings),
        returnValue: _Fake$ReminderSettingsTable_5(
          this,
          Invocation.getter(#reminderSettings),
        ),
      ) as _i3.$ReminderSettingsTable);

  @override
  _i3.$CustomRemindersTable get customReminders => (super.noSuchMethod(
        Invocation.getter(#customReminders),
        returnValue: _Fake$CustomRemindersTable_6(
          this,
          Invocation.getter(#customReminders),
        ),
      ) as _i3.$CustomRemindersTable);
  ...
  @override
  _i5.Future<List<_i3.BabyProfile>> getAllBabyProfiles() => (super.noSuchMethod(
        Invocation.method(
          #getAllBabyProfiles,
          [],
        ),
        returnValue:
            _i5.Future<List<_i3.BabyProfile>>.value(<_i3.BabyProfile>[]),
      ) as _i5.Future<List<_i3.BabyProfile>>);

  @override
  _i5.Future<_i3.BabyProfile?> getActiveBabyProfile() => (super.noSuchMethod(
        Invocation.method(
          #getActiveBabyProfile,
          [],
        ),
        returnValue: _i5.Future<_i3.BabyProfile?>.value(),
      ) as _i5.Future<_i3.BabyProfile?>);

  @override
  _i5.Future<int> insertBabyProfile(_i3.BabyProfilesCompanion? profile) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertBabyProfile,
          [profile],
  ...
  @override
  _i5.Future<int> updateBabyProfile(
    String? id,
    _i3.BabyProfilesCompanion? companion,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateBabyProfile,
  ...
  @override
  _i5.Future<bool> deleteBabyProfile(String? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteBabyProfile,
          [id],
        ),
  ...
  @override
  _i5.Future<List<_i3.CustomReminder>> getAllCustomReminders() =>
      (super.noSuchMethod(
        Invocation.method(
        ...
        returnValue:
            _i5.Future<List<_i3.CustomReminder>>.value(<_i3.CustomReminder>[]),
      ) as _i5.Future<List<_i3.CustomReminder>>);
